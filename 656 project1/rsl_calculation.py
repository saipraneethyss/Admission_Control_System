...
import math
import find_user_loc as user
import shadowing_loss as shadowing
...
EIRP_max = max_base_power - line_connector_loss + antenna_gain
EIRP_min = 30 #dBm

C_d = 57 #higher limit for channels in use
C_i = 0  #lower limit for channels in use
...
def EIRP(num_of_available_channels):
	...
	# print("num of channels: ",channels_in_use,"\nEIRP value is: ",EIRP_current_val)
